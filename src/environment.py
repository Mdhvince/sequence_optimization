...
class EnvSeqV1:
    ...
    def action_space(self):
        """
        :return: number of action id (N) - the agent will be able to select action ranging from 0 to N
        :return: number of action the agent have to take per steps
        """
        return self.N_SEATS, 2
